...
private:
	...
	private:
		HMODULE hModule = 0;
		static constexpr wchar_t* systemPath = const_cast<wchar_t*>(L"XAudio2_7.dll");
#ifdef _M_X64
		static constexpr wchar_t* folderPath = const_cast<wchar_t*>(L"XAudio\\XAudio2_7_64.dll");
		static constexpr wchar_t* localPath = const_cast<wchar_t*>(L"XAudio2_7_64.dll");
#else
		static constexpr wchar_t* folderPath = const_cast<wchar_t*>(L"XAudio\\XAudio2_7_32.dll");
		static constexpr wchar_t* localPath = const_cast<wchar_t*>(L"XAudio2_7_32.dll");
#endif
	};
public:
	class Channel
